  ...
  export default {
    ...
    methods: {
      showdetil() {
        ...
        let a = `<button class="btn btn-dark" id="back">Back Log</button>`
        let A = `<button class="btn btn-dark" id="back" disabled>Back Log</button>`
        let b = `<button class="btn btn-dark" id="totodo">To Do</button>`
        let B = `<button class="btn btn-dark" id="totodo" disabled>To Do</button>`
        let c = `<button class="btn btn-dark" id="doing">Doing</button>`
        let C = `<button class="btn btn-dark" id="doing" disabled>Doing</button>`
        let d = `<button class="btn btn-dark" id="done">Done</button>`
        let D = `<button class="btn btn-dark" id="done" disabled>Done</button>`
        let z = ''
